...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2024 a las 21:54:12
...
INSERT INTO `opiniones` (`id`, `opinion`, `prestadorId`, `usuario`) VALUES
...
('', '$2y$10$UxnN7dhPtHarA2nI.vEsLuYi2yoCOegN5IgFrnPpsLcmnhuDEz/P6');
...
ALTER TABLE `opiniones`
  ...
  ADD CONSTRAINT `opiniones_ibfk_2` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`usuario`);
